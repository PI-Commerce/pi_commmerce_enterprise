...
export const SEED_TEMPLATES: WaTemplate[] = [
  ...
  // Retail · Loyalty Card Upsell (c_ex17) — First Citizens Club invites + welcomes
  {
    id: "10248298001501",
    ...
    body: "Hi {{1}}, you shop with us often — join First Citizens Silver and unlock member-only perks like {{2}}. Membership is free.",
    footer: "First Citizens Club",
  ...
  },
  {
    ...
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "{{1}}, First Citizens Silver members saved ₹{{2}} on average last year. Join today — it takes 30 seconds.",
    footer: "First Citizens Club",
  ...
  },
  {
    ...
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "{{1}}, your spend qualifies you for First Citizens Gold. Unlock free tailoring, {{2}}% off, and priority checkout.",
    footer: "First Citizens Club",
    buttons: [{ type: "URL", text: "Upgrade to Gold" }, { type: "Quick Reply", text: "Maybe later" }],
  },
  {
    id: "10248298001504",
    name: "fcc_platinum_invite",
    category: "Marketing",
    language: "en",
    format: "TEXT",
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "{{1}}, we'd like to invite you to First Citizens Platinum. Enjoy a dedicated stylist, free alterations, and {{2}}.",
    footer: "First Citizens Club",
    buttons: [{ type: "URL", text: "Accept invitation" }, { type: "Quick Reply", text: "Learn more" }],
  },
  {
    id: "10248298001505",
    name: "fcc_black_invite",
    category: "Marketing",
    language: "en",
    format: "TEXT",
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "{{1}}, an exclusive invitation to First Citizens Black — our by-invite tier. Private previews, home delivery from every store, and {{2}}.",
    footer: "First Citizens Club",
    buttons: [{ type: "URL", text: "Accept invitation" }, { type: "Quick Reply", text: "Call me" }],
  },
  {
    id: "10248298001506",
    ...
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "Welcome to First Citizens Silver, {{1}}! Your member ID is {{2}}. Present it at checkout to start earning points.",
    footer: "First Citizens Club",
  ...
  },
  {
    ...
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "Welcome to First Citizens Gold, {{1}}! Your member ID is {{2}}. Free tailoring and priority checkout are now yours.",
    footer: "First Citizens Club",
    buttons: [{ type: "URL", text: "See member benefits" }],
  },
  {
    id: "10248298001508",
    name: "fcc_welcome_platinum",
    category: "Utility",
    language: "en",
    format: "TEXT",
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "Welcome to First Citizens Platinum, {{1}}! Your stylist {{2}} will reach out shortly. Enjoy your new benefits.",
    footer: "First Citizens Club",
    buttons: [{ type: "URL", text: "Meet your stylist" }],
  },
  {
    id: "10248298001509",
    name: "fcc_welcome_black",
    category: "Utility",
    language: "en",
    format: "TEXT",
    status: "Approved",
    createdAt: "15 Jul 2026",
    body: "Welcome to First Citizens Black, {{1}}. Your concierge {{2}} is available 24×7. We look forward to serving you.",
    footer: "First Citizens Club",
    buttons: [{ type: "URL", text: "Reach concierge" }],
  },
