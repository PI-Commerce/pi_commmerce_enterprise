...
// UI only, no secrets, no network: PiGenUiResult renders these fully offline. We keep one
// curated example for now (the 20-second cliff); more second-order insights land later.

export type GenUiFixtureKey = "duration_cliff";
...
export function pickGenUiFixtureKey(_query: string): GenUiFixtureKey {
