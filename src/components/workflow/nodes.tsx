 ...
 * specific node suggestion. Whichever composer is mounted — the demo composer
 * on existing/saved campaigns, the live AgentComposer on new ones — listens for
 * this event and pre-fills its input with the suggestion's prompt.
 */
...
export function WorkflowNode({ id, data, selected }: NodeProps<WorkflowNodeData>) {
  ...
  // on analytics (data.metrics) and read-only snapshots (showPiTips = false).
