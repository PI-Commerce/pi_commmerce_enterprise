...
import { ChevronRight, Sparkles, Play, Phone, Send, Bot, User } from "lucide-react";
...
type Section = "personality" | "instructions" | "knowledge" | "tools" | "escalation" | "memory";
        ...
        <div className="flex min-h-0 flex-1">
                ...
                <li key={id}>
                  <button
                    ...
                    className={cn(
                      ...
                      section === id ? "bg-accent font-medium text-foreground" : "text-muted-foreground hover:bg-accent/50 hover:text-foreground",
                    )}
                  >
                    {label}
                  </button>
          ...
          <section className="flex-1 overflow-y-auto px-8 py-6">
            <div className="mx-auto max-w-2xl space-y-5">
                ...
                <>
                  ...
                  <Field label="Languages">
                    <div className="flex flex-wrap gap-1.5">
                      {["English", "Hindi", "Tamil", "Telugu", "Marathi"].map((l, i) => (
                        <span key={l} className={cn("rounded-full border px-2.5 py-1 text-[11.5px]", i < 2 ? "border-foreground bg-accent" : "border-border text-muted-foreground")}>
                          {l}
                        </span>
                      ))}
                    </div>
              ...
              {section === "escalation" && (
                <>
                  <SectionTitle title="Escalation rules" desc="When to hand off to a human operator." />
