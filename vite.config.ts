...
// rollup still bundles those deps into the Cloudflare Worker, inflating worker size. Stub
// them to empty modules in the SSR build ONLY; the client build keeps the real ones as
// static-asset chunks (not subject to the worker size limit).
